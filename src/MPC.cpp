...
/*      fg[0] += 3000*CppAD::pow(vars[cte_start + i], 2);
      ...
      fg[0] += w_velocity * CppAD::pow(vars[v_start + i] - v_ref, 2);      
    }
...
/*      fg[0] += 5*CppAD::pow(vars[delta_start + i], 2);
      ...
      fg[0] += w_accelerate * CppAD::pow(vars[a_start + i], 2);
      // try adding penalty for speed + steer
      fg[0] += 700*CppAD::pow(vars[delta_start + i] * vars[v_start+i], 2);
    }
...
/*    vars_lowerbound[i] = -1.0e19;
    ...
    vars_lowerbound[i] = -Other_bound;
    vars_upperbound[i] = Other_bound;
  }
...
/*    vars_lowerbound[i] = -0.436332;
    ...
    vars_lowerbound[i] = -Steer_bound;
    vars_upperbound[i] = Steer_bound;
  }
